...
<p> The next presentation will be given by Yasmine ZERAIDI and Paule-Iris Djeni. </p> 

**Questions to answer for the next presentation :** 
- Minimal set of functionalities, optional additions?
- What do we want to achieve during the first Sprint1?
- All ready to start with the work? (tools, technology, team, ...)
- Features that we absolutely need and those we consider optional

### Project | Overview :

**Oragnisation**
* Focus on the website layout and functionality
* Quiz : what answers lead to what result
...
- Precise mockup and visual identity of the website completed

### Presentation | Overview

- IT match: what it is and what features will it have —> easy games and personality quiz
- Must-have features : navigation bar, menu game, quiz, QR code
- Additional features : game page records, easter eggs, fun facts, feedbacks, very aesthetic interface
- Visual identity : Home page with games and quiz, navigation menu (add interface sketches)
