// Players: parameters related to players  
    ...
    const playerI: "I" = "I" ; // create varables containing the letter for inside the cells (const as these variables will never changed)
    const AI: "T" ="T" ;
    let currentPlayer: "I" | "T" = playerI ; // game starts with I, it will change at each turn so use let
...
// Here will be all the fuctions
    ...
    function endGame(result: "I" | "T" | "tie"): void { // put a result parameter
         gameOver = true;
