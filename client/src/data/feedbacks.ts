...
export const feedbacks: Feedback[] = [
  ...
  { name: "M.P.Q.", anonymous: false, rating: 4, opinion: "A good study program with a nice mix of theoretical and practical modules. It has a bit of everything and allows students to discover different IT topics and find one that resonates with them.", liked: "Learning by doing, most modules use practical work to teach concepts.", favSubject: "Algorithms and OS", challenge: "3rd semester was tough due to issues with some professors.", advice: "A balanced program that should open a lot of doors. No IT background required to start." },
